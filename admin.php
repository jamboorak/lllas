        ...
        <section id="admin-login" class="bg-white p-6 md:p-10 rounded-xl shadow-2xl mb-12">
            ...
            <div id="admin-dashboard" class="mt-8 <?php echo $isLoggedIn ? '' : 'hidden'; ?>">
                ...
                <div class="flex border-b border-gray-200 mb-6">
                    ...
                    <button id="tab-concerns" onclick="showAdminTab('concerns')" class="tab-button px-4 py-2 text-sm font-medium rounded-t-lg text-gray-600 hover:bg-emerald-600 hover:text-white hover:shadow-lg hover:scale-105 transition-all duration-200">View Concerns</button>
